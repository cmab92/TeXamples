	...
	\begin{tikzpicture}[overlay]
		...
		\node[anchor=center] (2) at (orig) {
			\begin{pspicture}(0,0)(\widthornament,\widthornament)% 
				...
				\rput[tl](0,0){\psvectorian[width=\widthornament cm]{158}} % https://ftp.rrze.uni-erlangen.de/ctan/graphics/pstricks/contrib/pst-vectorian/doc/psvectorian.pdf
			\end{pspicture}
		};
		\node at ($(2.south) + (0,-2.25)$) {\LARGE\kitschy \meinetolleuni};
	\end{tikzpicture}
}
...
\title[\titleofthesis]{%
	...
	\small{
		Dokument zur Erlangung des Grades	\textit{Mag. rer. tex.}\\
		der Fakultät für Irgendwas und Noch Etwas\\
		der \meinetolleuni\\
		\vspace{1cm} \\
		\textit{von} Irgend R. Jemanden aus Hinterdupfing $\quad$ | $\quad$ 2025 \par
		\textit{\meinetolleuni,} \textit{Institut für Form mit oder ohne Inhalt}
	}
}
\author{}