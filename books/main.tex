...
\input{settings/pagestyle.tex}
\input{settings/usebibentry.tex}
\input{../src/para/citecommands.tex}
\input{../src/para/misccommands.tex}
\input{../src/para/theoremproofexample.tex}
